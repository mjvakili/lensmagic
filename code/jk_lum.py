...
lum_jk_mask = h5py.File("lum_jk_mask.h5")
lum_mask = lum_jk_mask["mask"][:]
lum_jk_mask.close()
lens_z_jk = lens_file_jk["redshift"][lum_mask]
lens_ra_jk = lens_file_jk["RA"][lum_mask]
lens_dec_jk = lens_file_jk["DEC"][lum_mask]
lens_file_jk.close()    
...
def lum_all(nbins):
    ...
    xshear_file = h5py.File("lum_jk.h5" , "w")
